...
//! for random access IO (i.e. `Read + Write + Seek`), while `BufReaderWriterSeq` is for sequential IO (i.e. `Read + Write`).  
//! 
...
//! reads.
//!
//! Note: For the `std::net::TcpStream` use case, the crate BufStream is likely more efficient for accomplishing similar 
//! functionality.
//!
//! # Example
//!
